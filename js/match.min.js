! function(e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
        ...
        var t;
        t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.Match = e()
    }
}(function() {
    return function e(t, n, i) {
        ...
        3: [function(e, t) {
            function n(e, t, n) {
                if (this.ev = new i, this.data = t.data || n, this.found = {}, this.timestamps = [], this.flippedPairs = 0, this.active = [], this.options = u.deepMerge(t, {
                        autoremove: !0,
                        size: {
                            x: 4,
                            y: 4
                    ...
                    }), this.blocks_count = this.options.size.x * this.options.size.y, this.count = this.blocks_count / 2, this.blocks_count % 2) throw new Error("The number of blocks should be even.");
                if (this.ui = {
                        container: s(e)[0],
                        items: [],
                        template: t.templateElm ? s(t.templateElm)[0].outerHTML : t.template
                    }, !Array.isArray(this.data)) throw new Error("Data should be an array.")
            }
            ...
            n.prototype.check = function(e, t) {
                var n = e.getAttribute("data-pattern"),
                    i = t.getAttribute("data-pattern");
                return n === i ? (e._found = !0, t._found = !0, this.found[n] = [e, t], !0) : !1
                ...
                if (e.classList.add(this.options.classes.active), this.active[0])
                    if (this.active[0] && this.active[1]) this.deactivate(this.active[0]), this.deactivate(this.active[1]), this.activate(e);
                    else {
                        if (this.active[0] === e) return this;
                        if (this.active[1] = e, this.emit("pair-flip", this.active[0], this.active[1]), this.check.apply(this, this.active)) return this.emit("activate", e), this.emit("success", this.active[0], this.active[1]), this.options.autoremove && (this.active[0].remove(), this.active[1].remove(), this.deactivate(this.active[0]), this.deactivate(this.active[1])), Object.keys(this.found).length === this.count && this.win(), this
                    }
                else this.active[0] = e;
                ...
                var e = this;
                return s.call(this, this.ui.container.children, this.clicked), e.on("pair-flip", function() {
                    ++e.flippedPairs
                }), e
                ...
                return e && t.clear(), t.shuffle(), t.items = t.data.slice(0, this.blocks_count / 2), a(t.items, function(e, n) {
                    for (var i, r, s, a = 0; 2 > a; ++a) i = document.createElement("div"), i.setAttribute("data-pattern", n), r = document.createElement("div"), r.classList.add("front"), s = document.createElement("div"), s.classList.add("back"), i.appendChild(r), i.appendChild(s), r.innerHTML = o(t.ui.template, e), t.ui.items.push({
                        element: i,
                        data: e,
                        duplicate: !!a
                    }), t.emit("render", i, e, a)
                ...
                var e = this;
                return e.render(!0), e.timestamps[0] = new Date, e.timer = setInterval(function() {
            ...
            function n(e, t, n) {
                function r(n, i) {
                    Object.keys(n).forEach(function(o) {
                        return s = n[o], i.push(o), "object" == typeof s ? r(s, i) : (e = e.replace(new RegExp(t[0] + i.join(".") + t[1], "g"), s), void i.pop())
                    })
                }
                if (Array.isArray(t) || (n = t, t = ["{", "}"]), !n || n.constructor !== Object) return e;
                t = t.map(i);
                var s = null;
                return r(n, []), e
            }
            var i = e("regex-escape");
            t.exports = n
        }, {
            "regex-escape": 5
        }],
        ...
        6: [function(e, t) {
            function n(e, t, r, s) {
                var o = 0,
                    a = null;
                if ("string" == typeof e && (s = s ? n(s) : document, e = s.querySelectorAll(e)), i(e, NodeList) || i(e, HTMLCollection) || (e = [e]), "function" == typeof t)
                    for (Array.isArray(r) || (r = [r]); o < e.length; ++o) a = [e[o]].concat(r), t.apply(this, a);
                return e
            }
            var i = e("typpy");
            t.exports = n
        ...
        8: [function(e, t) {
            function n(e, t) {
                ...
                if (Array.isArray(e))
                    ...
                    for (i = Object.keys(e); n < i.length && t(e[i[n]], i[n], e) !== !1; ++n);
            }
            t.exports = n
        }, {}],
        9: [function(e, t) {
            ...
            function n(e, t) {
                ...
                var n, i, r = e,
                    s = e.length,
                    o = t.rng || Math.random;
                for (t.copy === !0 && (r = e.slice()); s;) n = Math.floor(o() * s), s -= 1, i = r[s], r[s] = r[n], r[n] = i;
                return r
            }
            n.pick = function(e, t) {
                ...
                if ("number" == typeof i && 1 !== i) {
                    for (var r, s = e.length, o = e.slice(), a = []; i;) r = Math.floor(n() * s), a.push(o[r]), o.splice(r, 1), s -= 1, i -= 1;
                    return a
                }
        ...
        10: [function(e, t) {
            (function(n) {
                ...
                i.prototype.merge = function(e, t) {
                    ...
                    t = s(t, {}), e = s(e, {});
                    for (i in t) n[i] = t[i];
                    for (i in e) void 0 !== e[i] && (n[i] = e[i]);
                    return n
                }, i.prototype.deepMerge = function() {
                    for (var e, t, n = {}, i = [].splice.call(arguments, 0); i.length > 0;)
                        if (e = i.splice(-1)[0], "object" === r(e))
                            for (t in e) e.hasOwnProperty(t) && ("object" === r(e[t]) ? n[t] = this.deepMerge(e[t], n[t] || {}) : void 0 !== e[t] && (n[t] = e[t]));
                    return n
                    ...
                    if (r.forEach(function(n) {
                        ...
                        if (Array.isArray(e)) t = [], e.forEach(function(e, n) {
                            t[n] = i.clone(e)
                        });
        ...
        11: [function(e, t) {
            function n(e, t, n) {
                return "function" == typeof t ? t(e) : (n = "boolean" === i(n) ? {
                    empty: n
                } : {
                    empty: !1
                }, n.empty ? e || t : i(e) === i(t) ? e : t)
            }
            var i = e("typpy");
            t.exports = n
        }, {
